...
class Util
{
    static escurecerCor(corHex: string, porcentagem: number) : string
    {
...
class FigCanvas
{
    insereLados: HTMLInputElement;
    seletorCores: HTMLInputElement;
    btGerarFigura: HTMLButtonElement;
    ...
    constructor()
    {
        ...
        this.insereLados = document.getElementById("insere-lados") as HTMLInputElement;
        this.seletorCores = document.getElementById("seletor-de-cor") as HTMLInputElement;
        this.btGerarFigura = document.getElementById("bt-gerar-figura") as HTMLButtonElement;
        this.canvas = document.getElementById("canvas-figura") as HTMLCanvasElement;
        this.ctx = this.canvas.getContext("2d") as CanvasRenderingContext2D;

        this.ajustarResolucaoCanvas();
    }

    ajustarResolucaoCanvas(): void
    {
